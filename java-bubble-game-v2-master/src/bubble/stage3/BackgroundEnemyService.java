...
public class BackgroundEnemyService implements Runnable{
	...
	public BackgroundEnemyService(Enemy enemy) {
		...
		try {
			if(Player.stage == 1) {
				image = ImageIO.read(new File("image/backgroundMapService3_1.png"));
				}
				else if(Player.stage == 2)
				{
					image = ImageIO.read(new File("image/backgroundMapService3_2.png"));
				}
				else if(Player.stage == 3)
				{
					image = ImageIO.read(new File("image/backgroundMapService3_3.png"));
				}
		} catch (Exception e) {
