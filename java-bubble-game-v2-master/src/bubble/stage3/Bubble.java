...
public class Bubble extends JLabel implements Moveable{
	...
	public Bubble(BubbleFrame_stage_3_1 mContext, BubbleFrame_stage_3_2 mContext2, BubbleFrame_stage_3_3 mContext3) {
		if(player.stage == 1) {
