...
@Getter
@Setter
public class BubbleFrame_stage_3_1 extends JFrame {
 
	private BubbleFrame_stage_3_1 mContext = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap3_1.png"));
		setContentPane(backgroundMap);
		player = new Player(mContext,null,null);
		add(player);
		enemys = new ArrayList<Enemy>();
		enemys.add(new Enemy(mContext,null,null,EnemyWay.RIGHT));
		enemys.add(new Enemy(mContext,null,null,EnemyWay.LEFT));
