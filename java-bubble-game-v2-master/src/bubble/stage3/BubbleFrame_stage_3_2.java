...
@Getter
@Setter
public class BubbleFrame_stage_3_2 extends JFrame {
 
	private BubbleFrame_stage_3_2 mContext2 = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap3_2.png"));
		setContentPane(backgroundMap);
		player = new Player(null,mContext2,null);
		add(player);
		enemys = new ArrayList<Enemy>();
		enemys.add(new Enemy(null,mContext2,null,EnemyWay.RIGHT));
		enemys.add(new Enemy(null,mContext2,null,EnemyWay.LEFT));
