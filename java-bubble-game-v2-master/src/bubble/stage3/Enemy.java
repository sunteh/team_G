...
public class Enemy extends JLabel implements Moveable {
	...
	public Enemy(BubbleFrame_stage_3_1 mContext,BubbleFrame_stage_3_2 mContext2,BubbleFrame_stage_3_3 mContext3,EnemyWay enemyWay) {
		if(Player.stage == 1) {	
	...
	private void initObject() {
		enemyR = new ImageIcon("image/enemy3R.png");
		enemyL = new ImageIcon("image/enemy3L.png");
	}
