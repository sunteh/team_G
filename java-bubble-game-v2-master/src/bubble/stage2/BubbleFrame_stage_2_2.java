...
@Getter
@Setter
public class BubbleFrame_stage_2_2 extends JFrame {
 
	private BubbleFrame_stage_2_2 mContext2 = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap2_2.png"));
