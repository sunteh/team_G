...
@Getter
@Setter
public class BubbleFrame_stage_2_1 extends JFrame {
 
	private BubbleFrame_stage_2_1 mContext = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap2_1.png"));
