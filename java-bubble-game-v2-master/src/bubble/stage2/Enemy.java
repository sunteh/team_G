...
public class Enemy extends JLabel implements Moveable {
	...
	private BubbleFrame_stage_2_1 mContext;
	private BubbleFrame_stage_2_2 mContext2;
	private BubbleFrame_stage_2_3 mContext3;
	...
	public Enemy(BubbleFrame_stage_2_1 mContext,BubbleFrame_stage_2_2 mContext2,BubbleFrame_stage_2_3 mContext3,EnemyWay enemyWay) {
		if(Player.stage == 1) {	
	...
	private void initObject() {
		enemyR = new ImageIcon("image/enemy2R.png");
		enemyL = new ImageIcon("image/enemy2L.png");
	}
