...
@Getter
@Setter
public class BubbleFrame_stage_2_3 extends JFrame {
 
	private BubbleFrame_stage_2_3 mContext3 = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap2_3.png"));
		setContentPane(backgroundMap);
		player = new Player(null,null,mContext3);
		add(player);
		enemys = new ArrayList<Enemy>();
		enemys.add(new Enemy(null,null,mContext3,EnemyWay.RIGHT));
		enemys.add(new Enemy(null,null,mContext3, EnemyWay.LEFT));
