...
public class Enemy extends JLabel implements Moveable {
	...
	public Enemy(BubbleFrame_stage_4_1 mContext,BubbleFrame_stage_4_2 mContext2,BubbleFrame_stage_4_3 mContext3,EnemyWay enemyWay) {
		if(Player.stage == 1) {	
	...
	private void initObject() {
		enemyR = new ImageIcon("image/enemy4R.png");
		enemyL = new ImageIcon("image/enemy4L.png");
	}
