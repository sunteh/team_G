...
@Getter
@Setter
public class BubbleFrame_stage_4_3 extends JFrame {
 
	private BubbleFrame_stage_4_3 mContext3 = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap4_3.png"));
