...
@Getter
@Setter
public class BubbleFrame_stage_4_1 extends JFrame {
 
	private BubbleFrame_stage_4_1 mContext = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap4_1.png"));
