...
@Getter
@Setter
public class BubbleFrame_stage_4_2 extends JFrame {
 
	private BubbleFrame_stage_4_2 mContext2 = this;
	...
	private void initObject() {
		backgroundMap = new JLabel(new ImageIcon("image/backgroundMap4_2.png"));
